...
interface FindAllTransactionByMerchantIdUseCasePresenter<
  SuccessType,
  FunctionalErrorType,
> {
...
export class FindAllTransactionByMerchantIdUseCase<
  SuccessType,
  FunctionalErrorType,
> implements
    IFindAllTransactionByMerchantIdUseCase<SuccessType, FunctionalErrorType>
{
  constructor(
    private transactionRepository: ITransactionRepository,
    private presenter: FindAllTransactionByMerchantIdUseCasePresenter<
      SuccessType,
      FunctionalErrorType
    >,
  ) {}
  ...
  async execute(
    merchantId: string,
  ): Promise<SuccessType | FunctionalErrorType> {
    try {
      const transactions =
