...
async function getMerchantInfo() {
  ...
  try {
    const response: Merchant = await axios
      .get(`http://localhost:3051/merchant/${route.params.id}`, {
        headers: {
...
async function activateMerchant() {
  try {
    const response = await axios.post(
      `http://localhost:3051/merchant/${route.params.id}/activate`,
      {},
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token_eemiPay')}`,
  ...
  <main class="container">
    <div class="page-header">
      ...
      <div class="merchant-id">
        ID: <span class="highlight">{{ route.params.id }}</span>
      </div>
    </div>
    ...
    <div v-else-if="merchant" class="content">
      ...
      <div class="info-card">
        ...
        <div class="info-grid">
          ...
          <div class="info-item" v-if="merchant.kbisUrl">
            ...
            <a :href="merchant.kbisUrl" target="_blank" class="document-link"> View Document </a>
          </div>
        </div>
      </div>
      ...
      <div class="actions-section">
        ...
        <div class="actions-grid">
          ...
          <button @click="deleteMerchant" class="action-btn delete-btn">Delete Merchant</button>
        </div>
      </div>
    </div>
