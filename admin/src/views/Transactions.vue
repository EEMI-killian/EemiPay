...
async function getAllTransactions() {
  ...
  try {
    const response: Transaction[] = await axios
      .get('http://localhost:3051/transaction', {
        headers: {
...
async function searchTransactions() {
  ...
  try {
    const response: Transaction[] = await axios
      .get(`http://localhost:3051/transaction/company/${searchQuery.value}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token_eemiPay')}`,
        },
      })
...
<template>
  ...
  <main class="container">
    <div class="page-header">
      ...
      <div class="search-section">
        <div class="search-bar">
          ...
          />
          <button @click="searchTransactions" class="search-btn">Search</button>
          <button @click="getAllTransactions" class="reset-btn">All</button>
        </div>
      </div>
    </div>
    ...
    <div v-else-if="transactions && transactions.length > 0" class="transactions-section">
      <div class="table-header">
        <div class="header-cell id-column">ID</div>
        <div class="header-cell amount-column">Amount</div>
        <div class="header-cell currency-column">Currency</div>
