...
async function getTransaction() {
    try {
        const response: Transaction = await axios.get(`http://localhost:3051/transaction/${route.params.id}`, {
            headers: {
    ...
    <main class="container">
        ...
        <div v-else-if="transaction" class="content">
            ...
            <div class="transaction-header">
                ...
                <div class="transaction-id">ID: <span class="highlight">{{ transaction.id }}</span></div>
            </div>
            ...
            <div class="operations-section">
                ...
                <div v-if="transaction.operations && transaction.operations.length > 0" class="operations-list">
                    <div v-for="operation in transaction.operations" :key="operation.id" class="operation-card">
