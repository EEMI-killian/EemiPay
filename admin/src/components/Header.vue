...
// Optionnel : réévaluer l'authentification lors de changements de route
router.afterEach(() => {
    checkAuth();
});
</script>
...
<template>
    <nav class="navbar-container">
        <div class="navbar-content">
            <h1><RouterLink to="/">Admin EemiPay</RouterLink></h1>
            <ul class="navbar-links">
                <li v-if="isAuthenticated"><RouterLink to="/merchants">Mes Marchands</RouterLink></li>
